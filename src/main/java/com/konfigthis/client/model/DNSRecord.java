...
public class DNSRecord {
  ...
  **/
   ...
   * @return the DNSRecord instance itself
   */
  public DNSRecord putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expiration, dnSRecord.expiration) &&
        ...
        Objects.equals(this.additionalProperties, dnSRecord.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiration, fqdn, recordType, values, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DNSRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DNSRecord>() {
           ...
           public DNSRecord read(JsonReader in) throws IOException {
             ...
             DNSRecord instance = thisAdapter.fromJsonTree(jsonObj);

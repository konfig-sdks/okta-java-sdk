...
public class SamlAttributeStatement {
  ...
  **/
   ...
   * @return the SamlAttributeStatement instance itself
   */
  public SamlAttributeStatement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filterType, samlAttributeStatement.filterType) &&
        ...
        Objects.equals(this.additionalProperties, samlAttributeStatement.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filterType, filterValue, name, namespace, type, values, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SamlAttributeStatement
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SamlAttributeStatement.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SamlAttributeStatement is not found in the empty JSON string", SamlAttributeStatement.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SamlAttributeStatement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SamlAttributeStatement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SamlAttributeStatement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SamlAttributeStatement.class));

       return (TypeAdapter<T>) new TypeAdapter<SamlAttributeStatement>() {
           @Override
           public void write(JsonWriter out, SamlAttributeStatement value) throws IOException {
           ...
           @Override
           public SamlAttributeStatement read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SamlAttributeStatement instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SamlAttributeStatement given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SamlAttributeStatement
  * @throws IOException if the JSON string is invalid with respect to SamlAttributeStatement
  */
  public static SamlAttributeStatement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SamlAttributeStatement.class);
  }

 /**
  * Convert an instance of SamlAttributeStatement to an JSON string
  *
  * @return JSON string
  */

 ...
 */
@JsonAdapter(InlineHookType.Adapter.class)public enum InlineHookType {
  ...
  public static class Adapter extends TypeAdapter<InlineHookType> {
    @Override
    public void write(final JsonWriter jsonWriter, final InlineHookType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public InlineHookType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return InlineHookType.fromValue(value);
    }
  }
}

...
public class User {
  ...
  public static final String SERIALIZED_NAME_TRANSITIONING_TO_STATUS = "transitioningToStatus";
  @SerializedName(SERIALIZED_NAME_TRANSITIONING_TO_STATUS)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    User user = (User) o;
    return Objects.equals(this.embedded, user.embedded) &&
        ...
        Objects.equals(this.passwordChanged, user.passwordChanged) &&
        Objects.equals(this.profile, user.profile) &&
        Objects.equals(this.status, user.status) &&
        Objects.equals(this.statusChanged, user.statusChanged) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(embedded, links, activated, created, credentials, id, lastLogin, lastUpdated, passwordChanged, profile, status, statusChanged, transitioningToStatus, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("transitioningToStatus");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        UserCredentials.validateJsonObject(jsonObj.getAsJsonObject("credentials"));
      }
      ...
      if (jsonObj.get("type") != null && !jsonObj.get("type").isJsonNull()) {
        UserType.validateJsonObject(jsonObj.getAsJsonObject("type"));
      }
  }

...
public class Duration {
  ...
  **/
   ...
   * @return the Duration instance itself
   */
  public Duration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.number, duration.number) &&
        Objects.equals(this.unit, duration.unit)&&
        Objects.equals(this.additionalProperties, duration.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Duration.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Duration>() {
           ...
           public Duration read(JsonReader in) throws IOException {
             ...
             Duration instance = thisAdapter.fromJsonTree(jsonObj);

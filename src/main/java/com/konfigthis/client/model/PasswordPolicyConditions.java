...
public class PasswordPolicyConditions {
  ...
  **/
   ...
   * @return the PasswordPolicyConditions instance itself
   */
  public PasswordPolicyConditions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authProvider, passwordPolicyConditions.authProvider) &&
        Objects.equals(this.people, passwordPolicyConditions.people)&&
        Objects.equals(this.additionalProperties, passwordPolicyConditions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authProvider, people, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PasswordPolicyConditions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PasswordPolicyConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PasswordPolicyConditions>() {
           ...
           public PasswordPolicyConditions read(JsonReader in) throws IOException {
             ...
             PasswordPolicyConditions instance = thisAdapter.fromJsonTree(jsonObj);

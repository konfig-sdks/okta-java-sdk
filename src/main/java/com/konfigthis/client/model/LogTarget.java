...
public class LogTarget {
  ...
  **/
   ...
   * @return the LogTarget instance itself
   */
  public LogTarget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alternateId, logTarget.alternateId) &&
        ...
        Objects.equals(this.id, logTarget.id) &&
        Objects.equals(this.type, logTarget.type)&&
        Objects.equals(this.additionalProperties, logTarget.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternateId, detailEntry, displayName, id, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LogTarget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LogTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LogTarget>() {
           ...
           public LogTarget read(JsonReader in) throws IOException {
             ...
             LogTarget instance = thisAdapter.fromJsonTree(jsonObj);

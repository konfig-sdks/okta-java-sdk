...
import com.konfigthis.client.model.LogIpAddress;
...
public class LogRequest {
  ...
  **/
   ...
   * @return the LogRequest instance itself
   */
  public LogRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipChain, logRequest.ipChain)&&
        Objects.equals(this.additionalProperties, logRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ipChain, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LogRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LogRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("ipChain") != null && !jsonObj.get("ipChain").isJsonNull()) {
        ...
        if (jsonArrayipChain != null) {
          ...
          for (int i = 0; i < jsonArrayipChain.size(); i++) {
            LogIpAddress.validateJsonObject(jsonArrayipChain.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LogRequest>() {
           ...
           public LogRequest read(JsonReader in) throws IOException {
             ...
             LogRequest instance = thisAdapter.fromJsonTree(jsonObj);

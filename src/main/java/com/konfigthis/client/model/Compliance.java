...
public class Compliance {
  ...
  private FipsEnum fips;

  public Compliance() {
  }

  public Compliance fips(FipsEnum fips) {
  ...
  **/
  ...
  public FipsEnum getFips() {
    return fips;
  }


  public void setFips(FipsEnum fips) {
   ...
   * @return the Compliance instance itself
   */
  public Compliance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fips, compliance.fips)&&
        Objects.equals(this.additionalProperties, compliance.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fips, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Compliance
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Compliance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Compliance>() {
           ...
           public Compliance read(JsonReader in) throws IOException {
             ...
             Compliance instance = thisAdapter.fromJsonTree(jsonObj);

...
public class LogUserAgent {
  ...
  **/
   ...
   * @return the LogUserAgent instance itself
   */
  public LogUserAgent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.browser, logUserAgent.browser) &&
        Objects.equals(this.os, logUserAgent.os) &&
        Objects.equals(this.rawUserAgent, logUserAgent.rawUserAgent)&&
        Objects.equals(this.additionalProperties, logUserAgent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(browser, os, rawUserAgent, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LogUserAgent
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LogUserAgent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LogUserAgent>() {
           ...
           public LogUserAgent read(JsonReader in) throws IOException {
             ...
             LogUserAgent instance = thisAdapter.fromJsonTree(jsonObj);

...
public class UserFactor {
  ...
  **/
   ...
   * @return the UserFactor instance itself
   */
  public UserFactor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.embedded, userFactor.embedded) &&
        Objects.equals(this.links, userFactor.links) &&
        Objects.equals(this.created, userFactor.created) &&
        ...
        Objects.equals(this.additionalProperties, userFactor.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(embedded, links, created, factorType, id, lastUpdated, provider, status, verify, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserFactor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserFactor.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserFactor is not found in the empty JSON string", UserFactor.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("verify") != null && !jsonObj.get("verify").isJsonNull()) {
        VerifyFactorRequest.validateJsonObject(jsonObj.getAsJsonObject("verify"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserFactor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserFactor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserFactor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserFactor.class));

       return (TypeAdapter<T>) new TypeAdapter<UserFactor>() {
           @Override
           public void write(JsonWriter out, UserFactor value) throws IOException {
           ...
           @Override
           public UserFactor read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserFactor instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserFactor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserFactor
  * @throws IOException if the JSON string is invalid with respect to UserFactor
  */
  public static UserFactor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserFactor.class);
  }

 /**
  * Convert an instance of UserFactor to an JSON string
  *
  * @return JSON string
  */

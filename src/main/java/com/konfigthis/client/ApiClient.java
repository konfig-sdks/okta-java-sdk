...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://your-subdomain.okta.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("api_token", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.apiToken != null) {
                this.setApiToken(configuration.apiToken);
            }
    ...
    public String getApiToken() {
        return ((ApiKeyAuth) this.getAuthentication("api_token")).getApiKey();
    }

    public void setApiToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api_token")).setApiKey(apiKey);
    }

    public void setApiTokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api_token")).setApiKeyPrefix(prefix);
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/2.16.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://your-subdomain.okta.com)
